...
class TestSlackSender:
    ...
    def test_send_bot_message_success(self):
        ...
        responses.add(responses.POST, bot_url, json={"ok": True, "ts": "1234567890.123456"}, status=200)
    ...
    def test_send_bot_message_with_thread(self):
        ...
        sender = SlackSender(bot_token="xoxb-test")
        result = sender.send_bot_message("#general", "Reply message", thread_ts="1234567890.123456")
    ...
    def test_network_timeout_handling(self):
        webhook_url = "https://hooks.slack.com/test"
        responses.add(responses.POST, webhook_url, body=responses.ConnectionError("Connection timeout"))
